...
class ResNet(nn.Module):
	...
	def __init__(self, block, layers, num_classes=13, dilated=True,
...
class myNet(nn.Module):
	def __init__(self,num_classes,layers,block=Bottleneck):
		'''
		layers: [3,4,6,3,3] for resnet50
		'''
		self.inplanes = 64
		super(myNet,self).__init__()
		# self.model = models.resnet50(pretrained=True)
		# self.wts = torch.load('mynet.pkl',map_location=torch.device('cpu'))
		# self.model.load_state_dict(self.wts)
