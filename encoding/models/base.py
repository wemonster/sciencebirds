...
class BaseNet(nn.Module):
	def __init__(self,nclass,model_name, backbone, aux, se_loss, jpu=True, dilated=False, norm_layer=None,
		...
		pretrained_model = "../models/resnet/pretrained_{}.pkl".format(model_name)
	...
	def base_forward(self, x):
		# print (x.size())
		x = self.pretrained.conv1(x) #2x
		# print (x.size())
		x = self.pretrained.bn1(x) #2x
		x = self.pretrained.relu(x) #2x
		c0 = x
		# print (x.size())
		x = self.pretrained.maxpool(x) #4x
		# print (x.size())
		c1 = self.pretrained.layer1(x) #4x
		# print (c1.size())
		c2 = self.pretrained.layer2(c1) #8x
		# print (c2.size())
		c3 = self.pretrained.layer3(c2) #8x
		# print (c3.size())
		c4 = self.pretrained.layer4(c3) #8x
		# print (c4.size())
		# print ('-'*20)
		if self.jpu:
