...
# Iteration intervals for showing the loss during training, on command
# line interface
...
__C.TRAIN.SCALES = (480, 840)

# Max pixel size of the longest side of a scaled input image
__C.TRAIN.MAX_SIZE = 1000

# Trim size for input images to create minibatch
__C.TRAIN.TRIM_HEIGHT = 244
__C.TRAIN.TRIM_WIDTH = 244
...
# For COCO, setting USE_ALL_GT to False will exclude boxes that are
# flagged as ''iscrowd''
...
# Only useful when TEST.MODE is 'top', specifies the number of top
# proposals to select
